...
var options = {
  ...
  title: {
      text: 'تورم ماهانه در آرژانتین، 1400',
      floating: true,
      offsetY: 350,
      align: 'center',
      style: {
...
var options = {
  ...
  xaxis: {
      categories: ['ایران', 'ایران', 'ایران', 'ایران', 'ایران', 'ایران', 'ایران', 'ایران', 'ایران', 'ایران'],        
  },
  states: {
      hover: {
          filter: 'none'
...
labels: ['قسمت A', 'قسمت B', 'قسمت C', 'قسمت D', 'قسمت E'],
fill: {
  opacity: 1
},
stroke: {
