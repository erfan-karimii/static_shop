...
var data = {
    categories: ['مهر, 1400', 'تیر, 1400', 'آبان, 1400', 'آذر, 1400', 'تیر, دی', 'مرداد, 1400', 'خرداد, 1400'],
    series: [
        {
            name: "بودجه",
...
var data = {
    categories: ['مهر', 'آبان', 'آذر', 'دی', 'تیر', 'خرداد'],
    series: [
        {
            name: "بودجه",
...
var data = {
    categories: ['مهر', 'آبان', 'آذر', 'تیر', 'خرداد', 'شهریور', 'بهمن', 'اسفند', 'دی', 'شهریور', 'مرداد', 'اریبهشت'],
    series: [
        {
            name: 'سئول',
...
var data = {
    categories: ["مهر", "آبان", "دی", "آذر", "تیر", "خرداد"],
    series: [
        {
            name: "بودجه",
            data: [5000, 3000, 5000, 7000, 6000, 4000]
    ...
    series: [
        ...
        },
        {
            ...
            data: [
                ...
                { x: 5600, y: 69.22, r: 2754430, label: 'پرو' },
                { x: 5800, y: 74.06, r: 2501738, label: 'ونزوئلا' },
                ...
                { x: 6900, y: 72.14, r: 3000463, label: 'پاناما' },
                ...
                { x: 16400, y: 71.64, r: 278289, label: 'باربادوس' },
                ...
                { x: 32100, y: 77.43, r: 89302754, label: 'ایلات متحده' }
            ]
        },
        {
            name: 'آسیا',
            data: [
                { x: 5600, y: 71.96, r: 92988000, label: 'چین' },
                { x: 5700, y: 61.29, r: 4863169, label: 'ترکمنستان' },
                { x: 7700, y: 69.66, r: 19018924, label: 'ایران' },
                { x: 7800, y: 66.07, r: 1514370, label: 'قزاقستان' },
                { x: 8100, y: 71.41, r: 14865523, label: 'تایلند' },
                { x: 9700, y: 71.95, r: 23522482, label: 'مالزی' },
                { x: 12000, y: 75.23, r: 25795938, label: 'عربستان' },
                { x: 13100, y: 72.85, r: 2903165, label: 'عمان' },
                { x: 19200, y: 75.58, r: 48598170, label: 'کره جنوبی' },
                { x: 19200, y: 73.98, r: 677886, label: 'بحرین' },
                { x: 20800, y: 79.17, r: 6199008, label: 'اسرائیل' },
                { x: 21300, y: 76.84, r: 2257549, label: 'کویت' },
                { x: 23200, y: 73.4, r: 840290, label: 'قطر' },
                { x: 25200, y: 74.99, r: 2523915, label: 'امارات متحده عرب' },
                { x: 25300, y: 77.06, r: 22749838, label: 'تایوان' },
                { x: 27800, y: 81.53, r: 4353893, label: 'سنگاپور' },
                { x: 29400, y: 81.04, r: 52733300, label: 'ژاپن' },
                { x: 34200, y: 81.39, r: 6855125, label: 'هنگ کنگ' }
            ]
        },
        {
            name: 'اروپا',
            data: [
                { x: 7700, y: 71.12, r: 2235555, label: 'رومانیا' },
                ...
                { x: 23300, y: 79.37, r: 40280780, label: 'اسپانیا' },
                { x: 27700, y: 79.54, r: 58057477, label: 'ایتالیا' },
                { x: 28400, y: 80.3, r: 898640, label: 'سوئد' },
                { x: 28700, y: 78.54, r: 22424609, label: 'آلمان' },
                { x: 28700, y: 79.44, r: 30424213, label: 'فرانسه' },
                { x: 29000, y: 78.24, r: 5214512, label: 'فنلاند' },
                { x: 29500, y: 78.68, r: 16318199, label: 'Netherlands' },
                { x: 29600, y: 78.27, r: 60270708, label: 'انگلیس' },
                { x: 30600, y: 78.44, r: 10348276, label: 'بلژیک' },
                { x: 31300, y: 78.87, r: 8174762, label: 'اتریش' },
                { x: 31900, y: 77.36, r: 3969558, label: 'ایرلند' },
                { x: 31900, y: 80.18, r: 293966, label: 'ایسلند' },
                { x: 32200, y: 77.44, r: 5413392, label: 'دانمارک' },
                { x: 33800, y: 80.31, r: 7450867, label: 'نیوزلند' }
            ]
        },
        {
            name: 'استرالیا',
            ...
            return '<div class="tui-chart-default-tooltip">' +
                '<div class="tui-chart-tooltip-head">' + items.legend + '</div>' +
                    '<table class="tui-chart-tooltip-body">' +
                        '<tr>' +
                            '<td>وزن</td>' +
                        '<td class="tui-chart-tooltip-value">' + items.x + 'کیلوگرم</td>' +
                    '</tr>' +
                    '<tr>' +
                        '<td>قد</td>' +
                            '<td class="tui-chart-tooltip-value">' + items.y + 'سانتی متر</td>' +
                        '</tr>' +
                    '</table>' +
                '</div>';
        }
...
var data = {
    categories: {
        x: ['مهر', 'آبان', 'آذر', 'تیر', 'خرداد', 'شهریور', 'بهمن', 'اسفند', 'دی', 'شهریور', 'مرداد', 'اریبهشت'],
        y: ['سئول', 'کانادا', 'سیدنی', 'تهران', 'دبی']
    },
    series: [
...
var data = {
    categories: ['بودجه', 'درآمد', 'امیدبه زندگی', 'بدهی'],
    series: [{
        name: '1399',
        data: [
