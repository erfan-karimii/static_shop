...
(function () {
  ...
  var prettyPrint = (function () {
     ...
     * <li> mark the {@code <pre>} and {@code <span class="code">} tags in your source with
     ...
     * another class to the {@code <pre>} or {@code <span class="code">} element to specify the
    ...
    var prettyPrintOne;
    /**
     * Find all the {@code <pre>} and {@code <span class="code">} tags in the DOM with
    ...
    (function () {
       ...
       * as in {@code <pre><span class="code">...</span> <span class="code">...</span> </pre>} or when there
       * is textual content.
       */
