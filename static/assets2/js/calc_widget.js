...
crypt_calc_style = 'background: ' + crypt_calc_background_color +
    ...
    ' font-size: ' + crypt_calc_font_size +
    '; color: ' + crypt_calc_font_color + ';';

crypt_calc_font_style = ' font-size: ' + crypt_calc_font_size + '; height: auto;';
...
<div class="cryptonatorwidget" style="border-radius:4px;padding:10px;' + crypt_calc_style + '">\
    <table width="100%" cellpadding="6">\
		<tr>\
			<td style="width:45%;">\
				<input id="amount-1" type="text" placeholder="مقدار" style="width:100%;' + crypt_calc_font_style + '">\
			</td>\
			<td style="width:55%;">\
		...
		<tr>\
			<td style="width:45%;">\
				<input id="amount-2" type="text" placeholder="مقدار" style="width:100%;' + crypt_calc_font_style + '">\
			</td>\
			<td style="width:55%;">\
